    ...
    <div className="mt-10 -mx-10 mb-24">
      ...
      <div className="p-6 flex flex-col gap-3">
        <h1 className=" font-bold text-[35px]">
          Collect moments, not things, on the road in a van.
        </h1>
        <p>
          Welcome to our van rental company, where we specialize in providing
          top-quality vans for all your travel needs. We understand the
          excitement and freedom that comes with hitting the road, and our
          mission is to make your journey unforgettable.
        </p>
        <p>
