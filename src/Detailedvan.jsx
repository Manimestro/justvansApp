    ...
    return (
      <div className="bg-white mt-6 flex  p-4 flex-col gap-6 w-11/12  ">
        <Link className="flex rounded-lg  flex-row gap-4 min-w-[150px]   ">
          <img
            className="  rounded-md w-4/12 min-w-[150px] max-w-[200px]"
            src={vanData.imageUrl}
            alt="img"
          />
          <div className="w-6/12 mt-6 ml-4 ">
            <button className={`py-1 px-4  bg-orange-200  rounded-md  `}>
              {" "}
              {vanData.type}
            </button>
            <p className="text-[25px]  font-bold w-fit mt-2">{vanData.name}</p>
            <p className=" text-[16px] font-bold w-fit ">
              &#8377;{vanData.price}/day
            </p>
          </div>
        </Link>
  ...
  return (
    <div className="  flex flex-col gap-3">
      <p className="capitalize ">
        <span className="font-bold text-[16px]">Name: </span> {name}
      </p>
      <p className="capitalize ">
        <span className="font-bold text-[16px]">Category: </span> {type}
      </p>
      <p className="capitalize ">
      ...
      <p className="capitalize ">
        <span className="font-bold text-[16px]">Visibility: </span> Public
      </p>
    </div>
  );
}
...
function Pricing() {
  ...
  return (
    <div>
      <p className="">
        <span className="font-bold text-[22px]">&#8377; {price}</span>/day{" "}
      </p>
    </div>
  );
}
